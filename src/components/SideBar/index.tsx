...
const OrgSideBar = ({ organizationItems, myAccountItems }: SidebarProps) => {
  ...
  return (
    <>
      <div
        className="flex min-h-0 self-stretch"
        style={{
          boxShadow: '0px 2px 8px 0px #00000033',
          minHeight: 'calc(118dvh - 72px)',
        }}
      >
        <Sidebar
        ...
        >
          ...
          >
            <div className="flex-1">
              <aside className="min-h-[calc(var(--app-vh)_-_72px)] w-full min-w-[196px] max-w-[250px] overflow-y-auto bg-white scrollbar-hide">
                <ul className="mt-12 flex flex-col gap-3 px-3">
                  ...
                  <li className="mb-2 mt-2 px-4 font-semibold text-black">
                    <h2>Organization</h2>
                  </li>
                      ...
                      <a className="ml-1">
                        <li
                          className={`${item.href === undefined && 'cursor-not-allowed'} ${
                            pathname === item.href
                              ? 'rounded-full bg-[#E2F3FF] py-[6px] font-semibold text-black'
                              : 'rounded-full text-[#616161]'
                          } px-4 py-[2px] font-normal`}
                        >
                          {item.label}
                        </li>
                      </a>
                  ...
                  <br />
                  <li className="">
                    <h2 className="mb-2 px-4 font-semibold text-[#212121]">
                      My Account
                    </h2>
                  </li>
