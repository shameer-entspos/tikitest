...
const DraftsListing = () => {
  ...
  const filterData = (data ?? []).filter((app: JSAAppModel) => {
    if (searchQuery !== '') {
    ...
    <>
      <div className="absolute inset-0 z-10 flex h-[calc(var(--app-vh)-70px)] w-full max-w-[1360px] flex-col bg-white px-4 pt-4 font-Open-Sans">
        ...
        <div className="flex items-center">
          ...
          <h2 className="text-2xl font-bold ml-2">Draft</h2>
        </div>
        <div className="flex items-center ">
          ...
          <div className="mb-4 mt-4 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h2 className="ml-2 text-2xl font-bold">Draft</h2>
            </div>
          ...
          <table className="w-full border-collapse">
            <thead className="text-sm font-normal text-[#616161]">
              <tr className="max-h-[40px] w-full">
                <th className="col-span-4 flex rounded-l-lg bg-[#F5F5F5] px-4 py-3 text-left">
                  JSA Name
                  <img
                ...
                {sortedData.map((item: JSAAppModel, index: number) => (
                  ...
                  >
                    <td
                      ...
                      onClick={() => {
                        router.push(
                          `/user/apps/jsa/${context.state.jsaAppId}/${item?._id}/${item?.saveAs ?? 'Draft'}?from=drafts`
                        );
                      }}
                    >
                      {item.name}
                    ...
                    <td className="hidden p-2 sm:table-cell">
                      ...
                      >
                        {item.projectIds.length > 0 && item.projectIds[0].name}
              ...
              <ModalHeader className="flex flex-row items-center gap-2 border-b-2 border-gray-200 px-5 py-5">
                <div>
                  ...
                  <p className="mt-1 text-sm font-normal text-[#616161]">
                    Filter by the following selections and options below.
                  </p>
                </div>
              </ModalHeader>
