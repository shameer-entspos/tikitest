...
export function JSADetailActivitySection({
  JSASubmissionDetail,
}: {
  JSASubmissionDetail: JSAAppModel | undefined;
}) {
  ...
  const { data, isLoading } = useQuery({
    queryFn: () =>
      getOneSubmissionactivitiesList({
        axiosAuth,
        id: JSASubmissionDetail?._id ?? "",
      }),
    queryKey: [`getSingleSubmissionActivites${JSASubmissionDetail?._id}`],
    onSuccess: () => {},
  });
