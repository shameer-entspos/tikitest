...
import LiveBoardItem from './LiveBoard_Item';
...
import CreateSHHazards from './SH_Hazard/Create_SH_Hazard';
...
export default function LiveBoardScreen() {
  ...
  return (
    <>
      <div
        className={`absolute inset-0 z-10 flex w-full max-w-[1360px] flex-col bg-white px-4 pt-4 font-Open-Sans ${
          isNavbarVisible
            ? 'h-[calc(var(--app-vh)-70px)]'
            : 'h-[calc(var(--app-vh))]'
        }`}
      >
        {/* ///////////////// Middle content ////////////////////// */}
        ...
        <div className="flex h-full flex-1 flex-col justify-start overflow-auto scrollbar-hide">
            ...
            <div className="breadCrumbs flex justify-between p-2">
              <div className="flex justify-start gap-5">
                <ul className="breadcurmb flex items-center gap-[10px]">
                  <li className="hidden text-base text-[#757575] sm:block">
                    Tiki Apps
                  </li>
              ...
              <div className="flex flex-wrap items-end justify-end gap-y-2">
                <div className="flex items-center">
                  ...
                  <label className="mx-2 flex items-center space-x-2">
                    ...
                    <Switch
                      id="custom-screen-switch-component"
                      // ripple={!adminMode}
          ...
          <div className="relative flex-1">
            {isLoading ? (
              ...
              <>
                <div className="grid grid-cols-1 items-center justify-center gap-2 p-4 sm:grid-cols-2 md:grid-cols-3 md:gap-3 lg:grid-cols-4 lg:gap-4">
                  {(filterData ?? []).map((item, index) => (
                    <LiveBoardItem key={index} data={item} />
                  ))}
                </div>
