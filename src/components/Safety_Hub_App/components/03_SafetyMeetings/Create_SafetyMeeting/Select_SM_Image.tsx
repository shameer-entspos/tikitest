...
const SelectSMImages = ({
  ...
  const uploadedKeys = useMemo(
    () => uploadedImages ?? (state.smImages ?? []),
    [state.smImages, uploadedImages]
  );
  ...
  return (
    <StagedImageUploadField
      ...
      helperText={
        type === 'comment'
          ? undefined
          : 'Selected images stay staged until you submit this form.'
      }
