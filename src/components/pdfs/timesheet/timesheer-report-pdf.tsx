...
const TimesheetReportPDF = ({ data }: { data: TimeSheet[] | undefined }) => {
  return (
    <Document title="Timesheets Report">
...
const Page1 = ({ data }: { data: TimeSheet[] | undefined }) => {
  return (
